...
const NotificationDashboard: React.FC<Props> = () => {
  const [notifications, setNotifications] = useState<Notification[]>([
    {
      id: '1',
      title: 'Water Tank Full Alert',
      message: 'Water tank is full',
      type: 'warning',
      timestamp: '2025-09-29T00:20:00Z',
      isRead: false,
    ...
    //   message: 'Unusual temperature variations detected. Monitor soil temperature sensors if needed.',
    //   type: 'warning',
    //   timestamp: '2025-09-29T00:20:00Z',
    //   isRead: true,
    //   category: 'monitoring'
    ...
    //   message: 'Potassium sensor is offline for 3 hours. Please check connection and battery status.',
    //   type: 'urgent',
    //   timestamp: '2025-09-28T00:20:00Z',
    //   isRead: false,
    //   category: 'system'
    // },
  ]);
    ...
    setNotifications(prevNotifications => [
      {
        ...
        message: "The water levels in tank are critically low",
        type: "urgent",
        timestamp: "2025-09-29T00:20:00Z",
        isRead: false,
        category: "soil-health",
  ...
  const filteredNotifications = useMemo(() => {
    return notifications.filter((notification) => {
      ...
      if (filterType === "urgent" && notification.type !== "urgent")
        return false;
            ...
            <div className="flex items-center gap-3">
              <div className="text-center sm:text-left">
                ...
                <p className="text-gray-600 mt-1 text-sm sm:text-base">
                  Stay updated with important notices and system alerts
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="divide-y divide-gray-200">
            {filteredNotifications.length === 0 ? (
              ...
              filteredNotifications.map((notification) => (
                <div
                  key={notification.id}
                  className={`p-4 sm:p-6 hover:bg-blue-100 cursor-pointer transition-colors ${
                ...
                >
                  <div className="flex gap-3 sm:gap-4">
                    <div
                      className={`flex-shrink-0 p-4 rounded-full h-fit ${getNotificationColor(
                        notification.type
                      )}`}
                    >
